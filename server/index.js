  ...
  const init = async () => {
    ...
    const [jade, nicole, keila, taylor, Smores_Cookie, Key_Lime_Pie_Cookie, Oreo_Cookie, Banana_Peanut_Cookie] =
      await Promise.all([
        ...
        createProducts({ name: "Smore's Cookie", description: "Sourdough dscard sugar cookies with a layer of marshmellow coates in graham crackers topped with whipped chocolate frosting.", img_url:"/smores.jpeg" , price:1.25}),
